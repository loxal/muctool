...
private suspend fun recordSession(fingerprint: String, ip: InetAddress?, cookie: String?): String {
...
private suspend fun takeFingerprint(request: ApplicationRequest): String {
...
private suspend fun digest(digester: MessageDigest, data: ByteArray): ByteArray {
