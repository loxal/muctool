...
docker run -d -p 180:8080 --env MY_ENV=$my_env --env MY_ENV_SINGLE --label jvm_lang=kotlin --label sans-backing_service --name $DOCKER_IMAGE loxal/$DOCKER_IMAGE:$DOCKER_TAG
