...
docker exec router curl -X PUT \
  'http://finder:8001/sites/563714f1-96c0-4500-b366-4fc7e734fa1d/profile?siteSecret=56158b15-0d87-49bf-837d-89085a4ec88d' \
  -H 'content-type: application/json' \
  -d '{
      "id": "563714f1-96c0-4500-b366-4fc7e734fa1d",
      "secret": "56158b15-0d87-49bf-837d-89085a4ec88d",
...
docker exec router curl -X POST \
  'http://finder:8001/sites/563714f1-96c0-4500-b366-4fc7e734fa1d/recrawl?siteSecret=56158b15-0d87-49bf-837d-89085a4ec88d&clearIndex=true&isThrottled=true'
