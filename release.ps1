...
docker run -d -p 80:1180 -p 443:1443 --env MY_ENV=$docker_image --env MY_ENV_SINGLE --label jvm_lang=kotlin --label sans-backing_service --name $docker_image loxal/${docker_image}:${docker_tag}
